...
const ChooseBigContanctInfo = ({toggleTab, activeTab}) => {
          ...
          <Card>
            <CardBody>
              <Form>
                <Row>
                  <Col lg="12">
                    <h4 className="fw-normal">Genral Information</h4>
                  </Col>
                  <Col lg="6">
                    <div className="mb-3">
            ...
            <CardBody>
              <div class="mb-2">
                <div className="d-flex">
                  ...
                  <div>
                    <h5 className="d-flex gap-2 fw-normal">Kitchen</h5>
                  </div>
                </div>
              </div>
              <Form>
                <Row>
                  <Col lg="12">
                    <div className="mb-3">
                      <Label for="basicpill-address-input1">Description</Label>
                      <textarea
                        id="basicpill-address-input1"
                        className="form-control"
                        rows="3"
      ...
      <Row className="justify-content-center">
        <Col xl="8" sm="8">
          <Card>
            <CardBody>
              <Form>
                <Row>
                  <Col lg="12">
                    <h4 className="fw-normal">Contact Information</h4>
                  </Col>
                  <Col lg="6">
                    <div className="mb-3">
                  ...
                  <Col lg="6">
                    <div className="mb-3">
                      <Label for="basicpill-lastname-input2">Surname</Label>
                      <Input
                        type="text"
                        className="form-control"
          ...
          <div className="d-flex flex-wrap">
            <div
              className="actions clearfix text-start"
              style={{ width: '50%' }}
            >
              <button
...
export default ChooseBigContanctInfo;
