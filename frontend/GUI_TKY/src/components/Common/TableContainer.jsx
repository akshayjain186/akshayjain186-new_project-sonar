...
//             <tr>
//               {columns.map((col) => (
//                 <th key={col.header} style={{ backgroundColor: '#F4F8FC' }}>
//                   {col.header}
//                 </th>
//               ))}
//             </tr>
...
//       {/* Pagination */}
//       {totalRows > pageSize && (
//         <div className={`${paginationWrapper} d-flex justify-content-end mt-2`}>
//           <Pagination className={`${pagination} d-flex`} style={{ gap: '5px' }}>
//             {/* Previous Page */}
